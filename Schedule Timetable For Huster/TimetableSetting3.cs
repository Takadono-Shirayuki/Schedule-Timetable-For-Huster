    ...
    public partial class TimetableSetting3 : Form
    {
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                TimetableSetting2.Courseinfo[label1.Text.Split(": ")[1]].Coefficient = c1;
            ...
            try
            {
                ...
                label2.Text = "Course name: " + TimetableSetting2.Courseinfo[listBox1.SelectedItem.ToString()].CourseName;
                if (TimetableSetting2.Courseinfo[listBox1.SelectedItem.ToString()].Coefficient == int.MaxValue)
                {
                    comboBox1.Text = "inf";
                }
                else
                {
                    comboBox1.Text = TimetableSetting2.Courseinfo[listBox1.SelectedItem.ToString()].Coefficient.ToString();
                } 
                if (TimetableSetting2.Courseinfo[listBox1.SelectedItem.ToString()].Coefficient == int.MaxValue)
                {
                    comboBox1.Text = "inf";
